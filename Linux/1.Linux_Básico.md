...
1. [Introdução a Linux](./1.Linux_Básico.md)
2. [Introdução a scripts/comandos em Bash](./2.Introdução_ao_Bash.md)
...
Agora que já aprendemos boa parte da syntax, podemos aprofundar nosso conhecimento e entrar na construção de [_scripts_ e linhas de comando em bash](./2.Introdução_ao_Bash.md).
